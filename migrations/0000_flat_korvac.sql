...
ALTER TABLE "signature_status" ADD CONSTRAINT "signature_status_sign_id_users_sign_id_fk" FOREIGN KEY ("sign_id") REFERENCES "public"."users"("sign_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
